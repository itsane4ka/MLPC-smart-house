...
X_train, X_test, y_train, y_test = train_test_split(features, labels, shuffle=True, test_size=0.75, random_state=42)
...
# Here you can adjust the 'max_iter' if convergence issues occur
...
y_pred = logreg_classifier.predict(X_test_flat)
...
# Result: accuracy of Logistic Regression classifier: 0.84