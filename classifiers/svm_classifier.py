...
X_train, X_test, y_train, y_test = train_test_split(features, labels, shuffle=True, test_size=0.7, random_state=42)
...
# Initialize PCA, choose the number of components such as 95% variance is retained
...
svm_classifier = LinearSVC(random_state=42, dual=False, C=0.1, tol=1e-4)  # You can change the kernel based on your data characteristics
